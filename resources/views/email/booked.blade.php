...
<head>
    ...
    <title>Your Room is Successfully Booked!</title>
    ...
    <div class="card">
        ...
        <div class="heading">
            <p>
                ...
                Please keep this mail safely as all your details of your booking are included here.
            </p>
        </div>
        <div class="credentials">
            ...
            <br />
            <b>Members: </b> <br> <span>Adult: {{ $adult }}</span>
            <span>Children: {{ $children }}</span>
            <br>
            <b>Contact Number: </b><span>{{ $number }}</span> <br>
            <span>Total: Rs. {{ $total_price }}</span> </b> <br />
        </div>
